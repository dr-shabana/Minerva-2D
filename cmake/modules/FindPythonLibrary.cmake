...
if (Python_Interpreter_FOUND)
    ...
    unset(MINERVA2D_PYTHONPATH_V4 CACHE)
    unset(MINERVA2D_PYTHONPATH_V5 CACHE)
    ...
    list(TRANSFORM _python_prefix_path_v4 APPEND "/lib/minerva2d-python-libs")
    cmake_path(CONVERT "${_python_prefix_path_v4}" TO_NATIVE_PATH_LIST MINERVA2D_PYTHONPATH_V4 NORMALIZE)
    ...
    cmake_path(CONVERT "${_python_prefix_path_v5}" TO_NATIVE_PATH_LIST MINERVA2D_PYTHONPATH_V5 NORMALIZE)

    message(STATUS "Minerva site-packages directories for SIP v4: ${MINERVA2D_PYTHONPATH_V4}")
    message(STATUS "Minerva site-packages directories for SIP v5+: ${MINERVA2D_PYTHONPATH_V5}")
endif()
