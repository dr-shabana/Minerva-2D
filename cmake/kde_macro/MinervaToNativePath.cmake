...
# minerva2d_to_native_path(<path_list> <output_var>)
#
...
# Usage:
#
# minerva2d_to_native_path("${MINERVA2D_PYTHONPATH}" _minerva2d_pythonpath)

function (minerva2d_to_native_path path_list output_var)
    if(WIN32)
...
# minerva2d_to_native_environment_path_list(<path_list> <output_var>)
#
...
# Usage:
#
# minerva2d_to_native_environment_path_list("${MINERVA2D_PYTHONPATH}" _minerva2d_pythonpath)


function (minerva2d_to_native_environment_path_list path_list output_var)
    minerva2d_to_native_path("${path_list}" _output_var)
