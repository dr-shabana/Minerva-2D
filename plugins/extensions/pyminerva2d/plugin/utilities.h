...
//
// A couple of useful macros and functions used inside of pyminerva2d_engine.cpp and pyminerva2d_plugin.cpp.
//
...
#ifndef __PYMINERVA2D_UTILITIES_H__
# define  __PYMINERVA2D_UTILITIES_H__
...
namespace PyMinerva
{
    enum InitResult {
        ...
        INIT_CANNOT_LOAD_PYMINERVA2D_MODULE,
    };
     ...
     * Note: PyMinerva::initialize() must be called
...
public:
     ...
     *   File "/home/shahhaqu/.kde/share/apps/minerva2d/pyminerva2d/pluginmgr.py", line 13, in <module>
     *     import kdeui
     ...
     */
    bool functionCall(const char* functionName, const char* moduleName = PYMINERVA2D_ENGINE);
     ...
     */
    bool itemStringDel(const char* item, const char* moduleName = PYMINERVA2D_ENGINE);
     ...
     */
    PyObject* itemString(const char* item, const char* moduleName = PYMINERVA2D_ENGINE);
     ...
     */
    bool itemStringSet(const char* item, PyObject* value, const char* moduleName = PYMINERVA2D_ENGINE);
     ...
     */
    PyObject* moduleDict(const char* moduleName = PYMINERVA2D_ENGINE);
    ...
    static const char* PYMINERVA2D_ENGINE;
...
#endif                                                      //  __PYMINERVA2D_UTILITIES_H__
