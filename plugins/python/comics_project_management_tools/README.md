...
This is the Comics Project Management Tools python plugin for Minerva.
...
Double click the new page to open in Minerva.
...
When you then store it as marvel.txt put into the directory "key_characters", Minerva will use the names from the list as suggestion for the character field in the meta-data.
...
Once you've done that, press export. Minerva will pop up a progress bar for you with the estimated time and progress, so you can estimate how long you will have to wait.
