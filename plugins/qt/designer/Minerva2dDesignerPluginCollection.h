...
class MinervaDesignerPluginCollection : public QObject, public QDesignerCustomWidgetCollectionInterface
{
    Q_OBJECT
...
public:
    MinervaDesignerPluginCollection(QObject *parent = nullptr);
