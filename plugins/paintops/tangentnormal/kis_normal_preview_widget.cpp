        ...
        : QLabel(parent)
{
    ...
    m_greenChannel = 2;
    m_blueChannel = 4;
    //TODO: this can be changed in frameworks to  KoResourcePaths::findResource("kis_images", "minerva2d-tangentnormal.png");
    m_fileName = KoResourcePaths::findAsset("kis_images", "minerva2d-tangentnormal-preview.png");
