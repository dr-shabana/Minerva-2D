...
struct PAINTOP_EXPORT KisMinervaSensorData : boost::equality_comparable<KisMinervaSensorData>
{
    KisMinervaSensorData();
    
    inline friend bool operator==(const KisMinervaSensorData &lhs, const KisMinervaSensorData &rhs) {   
...
class PAINTOP_EXPORT KisMinervaSensorPack : public KisSensorPackInterface
{
public:
    /**
...
public:
    KisMinervaSensorPack(Checkability checkability);
    KisMinervaSensorPack(const KisMinervaSensorPack &rhs) = default;
    ...
    const KisMinervaSensorData& constSensorsStruct() const;
    KisMinervaSensorData& sensorsStruct();
