...
KisMinervaSensorData::KisMinervaSensorData()
...
KisMinervaSensorPack::KisMinervaSensorPack(Checkability checkability)
    : m_checkability(checkability)
{
}

KisSensorPackInterface * KisMinervaSensorPack::clone() const
{
    return new KisMinervaSensorPack(*this);
}

std::vector<const KisSensorData *> KisMinervaSensorPack::constSensors() const
{
    return detail::sensors(&m_data);
}

std::vector<KisSensorData *> KisMinervaSensorPack::sensors()
{
    return detail::sensors(&m_data);
}

const KisMinervaSensorData& KisMinervaSensorPack::constSensorsStruct() const 
{
    return m_data;
}

KisMinervaSensorData& KisMinervaSensorPack::sensorsStruct()
{
    return m_data;
}

bool KisMinervaSensorPack::compare(const KisSensorPackInterface *rhs) const
{
    const KisMinervaSensorPack *pack = dynamic_cast<const KisMinervaSensorPack*>(rhs);
...
bool KisMinervaSensorPack::read(KisCurveOptionDataCommon &data, const KisPropertiesConfiguration *setting) const
{
...
void KisMinervaSensorPack::write(const KisCurveOptionDataCommon &data, KisPropertiesConfiguration *setting) const
{
...
int KisMinervaSensorPack::calcActiveSensorLength(const QString &activeSensorId) const
{
