...
class NotarizationHandler:
    ...
    def __init__(self
                 ...
                 , password: str=None
                 , provider: str=None
                 , store_credentials_key: str="MinervaNotarizeAccount"
                 ):
...
def main_notarize():
    parser = argparse.ArgumentParser(prog='macos notarize minerva2d.app',
                                     description='Utility that receives minerva2d.app and sends for notarization',
                                     )
    parser.add_argument('target', type=pathlib.Path
                        , help='signed minerva2d.app for notarization')
    ...
    if args.appleid:
        ...
        print("   By default this script searches for 'MinervaNotarizeAccount' key")
