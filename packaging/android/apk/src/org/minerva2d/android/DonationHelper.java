...
// "minerva2d.org" package, not "minerva2d.org.debug". To change the package name, edit
...
public class DonationHelper implements PurchasesUpdatedListener, BillingClientStateListener, ProductDetailsResponseListener {
    ...
    private static final String TAG = "minerva2d.DonationHelper";
