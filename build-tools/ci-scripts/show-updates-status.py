...
print('')
printZSyncStat("Channel: Stable", 'https://download.kde.org/stable/minerva2d/updates/Minerva-Stable-x86_64.appimage.zsync')
print('')
printZSyncStat("Channel: Beta (unstable)", 'https://download.kde.org/unstable/minerva2d/updates/Minerva-Beta-x86_64.appimage.zsync')
print('')
printZSyncStat("Channel: Plus", 'https://autoconfig.kde.org/minerva2d/updates/plus/linux/Minerva-Plus-x86_64.appimage.zsync')
print('')
printZSyncStat("Channel: Next", 'https://autoconfig.kde.org/minerva2d/updates/next/linux/Minerva-Next-x86_64.appimage.zsync')
print('')
