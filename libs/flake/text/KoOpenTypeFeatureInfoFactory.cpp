    ...
    : d(new Private)
{
    ...
    initialMap.append(KoOpenTypeFeatureInfo(QByteArray("opbd"),
                      ...
                      i18nc("@tooltip", "Adjusts glyphs so they align by their optical bounds. Doesn't do anything in Minerva."),
                      {KoOpenTypeFeatureInfo::GPOS1}));
    ...
    initialMap.append(KoOpenTypeFeatureInfo(QByteArray("size"),
                      ...
                      i18nc("@tooltip", "Indicates how much the font is suitable for its current size. Does nothing in Minerva."),
                      {KoOpenTypeFeatureInfo::GPOS1}));
