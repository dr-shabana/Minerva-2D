...
public:
    ...
    /// \brief selectedTagIsReadOnly checks whether the tag is readonly (generated by Minerva)
    /// \return true if the tag was generated by Minerva, false if it's just a normal tag
