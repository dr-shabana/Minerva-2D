 ...
 *
 * Some of them work by pure coincidence, because minerva2dmenu.action defines the exact
 ...
 * explicitly created inside Minerva in KisMainWindow::createActions() and propertized
 * via the strings from minerva2dmenu.action.
 *
...
static constexpr KStandardActionInfo g_rgActionInfo[] = {
    ...
    { Preferences,   KStandardShortcut::Preferences, "options_configure", QT_TRANSLATE_NOOP("KStandardActions", "&Configure Minerva..."), {}, "configure" },
    ...
    // shortcut
    { HelpContents,  KStandardShortcut::Help, "help_contents", QT_TRANSLATE_NOOP("KStandardActions", "Minerva &Handbook"), {}, "help-contents" },
    ...
    { AboutApp,      KStandardShortcut::AccelNone, "help_about_app", QT_TRANSLATE_NOOP("KStandardActions", "&About Minerva"), {}, nullptr },
