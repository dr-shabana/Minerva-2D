...
void KisSelectionManager::toggleDisplaySelection()
{
    ...
    m_selectionDecoration->toggleSelectionVisibility();
    m_toggleDisplaySelection->blockSignals(true);
    m_toggleDisplaySelection->setChecked(m_selectionDecoration->selectionVisible());
...
void KisSelectionManager::slotStrokeSelection()
{
    ...
    KisNodeSP currentNode = m_view->canvasResourceProvider()->resourceManager()->resource(KoCanvasResource::CurrentMinervaNode).value<KisNodeWSP>();
