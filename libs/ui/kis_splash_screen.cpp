      ...
      , m_versionHtml(qApp->applicationVersion().toHtmlEscaped())
{
    ...
    m_brandingSvg = new QSvgWidget(QStringLiteral(":/minerva2d-branding.svgz"), lblSplash);
...
void KisSplashScreen::displayLinks(bool show) {
    ...
    if (show) {
        ...
        lblLinksText    << "<html>"
                        ...
                        << i18n("<p><span style=\" color:%1;\"><b>Using Minerva</b></span></p>",color);
        ...
        if (!KisMacosEntitlements().sandbox()) {
            ...
            lblLinksText    << i18n("<p><a href=\"https://minerva2d.org/support-us/\"><span style=\" text-decoration: underline; color:%1;\">Support Minerva's Development!</span></a></p>",color)
                            << i18n("<p><a href=\"https://minerva2d.org/\"><span style=\" text-decoration: underline; color:%1;\">Minerva Website</span></a></p>",color);
#ifdef Q_OS_MACOS
        }
#endif
        lblLinksText    << i18n("<p><a href=\"https://docs.minerva2d.org/en/user_manual/getting_started.html\"><span style=\" text-decoration: underline; color:%1;\">Getting Started</span></a></p>",color)
                        << i18n("<p><a href=\"https://docs.minerva2d.org/\"><span style=\" text-decoration: underline; color:%1;\">Manual</span></a></p>",color)
                        << "</td><td>"
                        << i18n("<p><span style=\" color:%1;\"><b>Coding Minerva</b></span></p>",color)
                        << i18n("<p><a href=\"https://minerva2d-artists.org\"><span style=\" text-decoration: underline; color:%1;\">User Community</span></a></p>",color)
                        << i18n("<p><a href=\"https://invent.kde.org/graphics/minerva2d\"><span style=\" text-decoration: underline; color:%1;\">Source Code</span></a></p>",color)
                        << i18n("<p><a href=\"https://api.kde.org/minerva2d/html/classMinerva.html\"><span style=\" text-decoration: underline; color:%1;\">Scripting API</span></a></p>",color)
                        << i18n("<p><a href=\"https://scripting.minerva2d.org/lessons/introduction\"><span style=\" text-decoration: underline; color:%1;\">Scripting School</span></a></p>",color)
                        << "</td></tr></table></body>"
                        << "</html>";
