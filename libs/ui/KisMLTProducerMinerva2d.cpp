/*
 * KisMLTProducerMinerva
 * Produces variable-speed audio within a restricted range of frames. Used internally by Minerva to drive audio-synced animation playback.
...
*/
extern "C" void* producer_minerva2d_init(mlt_profile profile,
...
void registerMinervaMLTProducer(Mlt::Repository *repository)
{
    repository->register_service(mlt_service_producer_type, "minerva2d_play_chunk", producer_minerva2d_init);
}
