    ...
    m_activeView(activeView)
{
    ...
    if (ffmpegInfo["enabled"].toBool()) {
        ...
        QMessageBox::warning(this, i18nc("@title:window", "Minerva"), i18n("FFMpeg not found! Please add a path to FFMpeg in the \"Advanced\" tab"));
    }
...
RenderedFrames KisDlgImportVideoAnimation::renderFrames(const QDir& directory)
{
    ...
    if ( !directory.mkpath(".") ) {
        QMessageBox::warning(this, i18nc("@title:window", "Minerva"), i18n("Failed to create a work directory, make sure you have write permission"));
        return frames;
    }
    ...
    if (exportDuration / fps > 100.0) {
        if (QMessageBox::warning(this, i18nc("Title for a messagebox", "Minerva"),
                             i18n("Warning: you are trying to import more than 100 frames into Minerva.\n\n"
    ...
    if ( frameFileList.isEmpty() ) {
         QMessageBox::critical(this, i18nc("@title:window", "Minerva"), i18n("Failed to export frames from video"));
    }
...
void KisDlgImportVideoAnimation::slotImportDurationChanged(qreal time)
{
    ...
    if (maxFrames < frames) {
        ...
        QString text_trc =  i18nc("part of warning in video importer."
                                  , "Minerva does not support the video transfer curve (%1), it will be loaded as linear."
                                  , KoColorProfile::getTransferCharacteristicName(m_videoInfo.colorTransfer));
...
void KisDlgImportVideoAnimation::slotFFProbeFile()
{
    ...
    if (!filenames.isEmpty()) {
        ...
        QMessageBox::warning(this, i18nc("@title:window", "Minerva"), i18n("FFProbe is invalid!"));
    }
    ...
    if (!filenames.isEmpty()) {
        ...
        if (ffmpegInfo["enabled"].toBool()) {
            if (ffmpegInfo["custom"].toBool()) {
                ...
                QMessageBox::warning(this, i18nc("@title:window", "Minerva"), i18n("FFMpeg is invalid!"));
            }
        ...
        m_ui.tabGeneral->setEnabled(false);
        QMessageBox::critical(this, i18nc("@title:window", "Minerva"), i18n("No FFMpeg found!"));
    }
...
KisBasicVideoInfo KisDlgImportVideoAnimation::loadVideoInfo(const QString &inputFile)
{
    ...
    std::function<void(void)> warnFFmpegFormatSupport = [this](){
        QMessageBox::warning(this, i18nc("@title:window", "Minerva"), i18n("Your FFMpeg version does not support this format"));
    };
    ...
    if ( ffprobeJsonObj["error"].toInt() == FFProbeErrorCodes::UNSUPPORTED_CODEC) {
        ...
        if ( videoInfoData.stream == -1 ) {
            QMessageBox::warning(this, i18nc("@title:window", "Minerva"), i18n("No video stream could be found!"));
            return {};
        }
        ...
        if ( !videoInfoData.frames && !videoInfoData.duration ) {
            ...
            if ( ffprobeJsonObj["error"].toInt() != FFProbeErrorCodes::NONE ) {
                QMessageBox::warning(this, i18nc("@title:window", "Minerva"), i18n("Failed to load video information"));
                return {};
            }
