...
QString KisImportExportComplexError::qtErrorMessage() const
{
    ...
    switch (m_error) {
        ...
        case QFileDevice::FileError::PermissionsError :
            return i18n("Permission denied. Minerva is not allowed to read or write to the file.");
    ...
    if (errorFieldUsed == CannotRead) {
        ...
        switch (codeId) {
            ...
            case ImportExportCodes::NoAccessToRead:
                return i18n("Permission denied: Minerva is not allowed to read the file.");
            ...
            case ImportExportCodes::NoAccessToWrite:
                return i18n("Permission denied: Minerva is not allowed to write to the file.");
            ...
            case ImportExportCodes::FileFormatNotSupported:
                return i18n("Minerva does not support this file format.");
