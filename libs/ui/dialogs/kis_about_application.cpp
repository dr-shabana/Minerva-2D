...
KisAboutApplication::KisAboutApplication(QWidget *parent)
    : KoDialog(parent)
{
    setWindowTitle(i18n("About Minerva"));
    ...
    QString sponsors = i18n(
        ...
        "<p align=\"center\"> <a href=\"https://www.fosshub.com/Minerva.html\"><img src=\":/fosshub.png\"></a> "
    ...
    credits.append(i18n(".</p><p><i>For supporting Minerva development with advice, icons, brush sets and more.</i></p></body></html>"));
    ...
    QString license = i18n("<html>"
                           ...
                           "<p>Minerva is released under the GNU General Public License (version 3 or any later version).</p>"
                           "<p>This license grants people a number of freedoms:</p>"
                           "<ul>"
                           "<li>You are free to use Minerva, for any purpose</li>"
                           "<li>You are free to distribute Minerva</li>"
                           "<li>You can study how Minerva works and change it</li>"
                           "<li>You can distribute changed versions of Minerva</li>"
                           "</ul>"
                           "<p>The Minerva Foundation and its projects on minerva2d.org are <b>committed</b> to preserving Minerva as free software.</p>"
                           "<h1 align=\"center\">Your artwork</h1>"
                           "<p>What you create with Minerva is your sole property. All your artwork is free for you to use as you like.</p>"
                           "<p>That means that Minerva can be used commercially, for any purpose. There are no restrictions whatsoever.</p>"
                           "<p>Minerva’s GNU GPL license guarantees you this freedom. Nobody is ever permitted to take it away, in contrast "
    ...
    if (thirdPartyFile.open(QIODevice::ReadOnly | QIODevice::Text)) {
        ...
        QString thirdPartyHtml = i18n("<html>"
                                      "<head/>"
                                      "<body>"
                                      "<h1 align=\"center\"><b>Third-party Libraries used by Minerva</b></h1>"
                                      "<p>Minerva is built on the following free software libraries:</p><p><ul>");
