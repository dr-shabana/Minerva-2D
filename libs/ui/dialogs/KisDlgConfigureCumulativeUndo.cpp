    ...
    , m_d(new Private(data))
{
    ...
    intExcludeFromMerge->setToolTip(
        i18nc("@info:tooltip",
              "The number of last strokes that Minerva will not merge "
    ...
    QLabel *help = new QLabel(
        i18n("Cumulative Undo allows Minerva to merge undo actions "
             "and make undo history cleaner. Minerva will still keep "
             ...
             "\"Exclude last strokes from merge\", Minerva will try "
