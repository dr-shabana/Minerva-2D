...
Minerva* Minerva::s_instance = 0;

struct Minerva::Private {
    Private() {}
...
Minerva::Minerva(QObject *parent)
    : QObject(parent)
    , d(new Private)
{
...
QList<QAction *> Minerva::actions() const
{
...
QAction *Minerva::action(const QString &name) const
{
    KisMainWindow *mainWindow = KisPart::instance()->currentMainwindow();
    if (!mainWindow) {
        return 0;
...
Document* Minerva::activeDocument() const
{
    KisMainWindow *mainWindow = KisPart::instance()->currentMainwindow();
    if (!mainWindow) {
        return 0;
...
void Minerva::setActiveDocument(Document* value)
{
...
bool Minerva::batchmode() const
{
    return d->batchMode;
}

void Minerva::setBatchmode(bool value)
{
    d->batchMode = value;
}


QList<Document *> Minerva::documents() const
{
    QList<Document *> ret;
...
QStringList Minerva::filters() const
{
...
Filter *Minerva::filter(const QString &name) const
{
...
QStringList Minerva::colorModels() const
{
...
QStringList Minerva::colorDepths(const QString &colorModel) const
{
...
QStringList Minerva::filterStrategies() const
{
    return KisFilterStrategyRegistry::instance()->keys();
}

QStringList Minerva::profiles(const QString &colorModel, const QString &colorDepth) const
{
...
bool Minerva::addProfile(const QString &profilePath)
{
...
Notifier* Minerva::notifier() const
{
    return d->notifier;
}

QString Minerva::version() const
{
    return MinervaVersionWrapper::versionString(true);
}

QList<View *> Minerva::views() const
{
    QList<View *> ret;
...
Window *Minerva::activeWindow() const
{
    KisMainWindow *mainWindow = KisPart::instance()->currentMainwindow();
    if (!mainWindow) {
        return 0;
...
QList<Window*>  Minerva::windows() const
{
    QList<Window*> ret;
...
QMap<QString, Resource*> Minerva::resources(QString &type) const
{
...
QList<QDockWidget*> Minerva::dockers() const
{
    KisMainWindow *mainWindow = KisPart::instance()->currentMainwindow();
...
QStringList Minerva::recentDocuments() const
{
...
Document* Minerva::createDocument(int width, int height, const QString &name, const QString &colorModel, const QString &colorDepth, const QString &profile, double resolution)
{
...
Document* Minerva::openDocument(const QString &filename)
{
    KisDocument *document = KisPart::instance()->createDocument();
...
Window* Minerva::openWindow()
{
    KisMainWindow *mw = KisPart::instance()->createMainWindow();
    return new Window(mw);
}

void Minerva::addExtension(Extension* extension)
{
...
QList< Extension* > Minerva::extensions()
{
    return d->extensions;
}

void Minerva::writeSetting(const QString &group, const QString &name, const QString &value)
{
    KConfigGroup grp = KSharedConfig::openConfig()->group(group);
    grp.writeEntry(name, value);
}

QString Minerva::readSetting(const QString &group, const QString &name, const QString &defaultValue)
{
    KConfigGroup grp = KSharedConfig::openConfig()->group(group);
    return grp.readEntry(name, defaultValue);
}

QIcon Minerva::icon(QString &iconName) const
{
    return KisIconUtils::loadIcon(iconName);
}

void Minerva::addDockWidgetFactory(DockWidgetFactoryBase* factory)
{
    KoDockRegistry::instance()->add(factory);
}

Minerva* Minerva::instance()
{
    if (!s_instance)
    {
        s_instance = new Minerva;
    }
    return s_instance;
}
 ...
 */
QObject *Minerva::fromVariant(const QVariant& v)
{
...
QString Minerva::minerva2d_i18n(const QString &text)
{
    return i18n(text.toUtf8().constData());
}

QString Minerva::minerva2d_i18nc(const QString &context, const QString &text)
{
    return i18nc(context.toUtf8().constData(), text.toUtf8().constData());
}

QString Minerva::getAppDataLocation()
{
    return KoResourcePaths::getAppDataLocation();
}

void Minerva::mainWindowIsBeingCreated(KisMainWindow *kisWindow)
{
