...
public:
    ...
    void applyMaxOutAlpha(KisPainter *painter, const QRect &rect, MinervaUtils::ThresholdMode thresholdMode);
...
private:
    void applyImpl(KisPainter *painter, const QRect &rect, MinervaUtils::ThresholdMode thresholdMode);
